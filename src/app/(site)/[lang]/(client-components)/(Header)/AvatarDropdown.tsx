...
export default function AvatarDropdown({ className = "" }: Props) {
  // Initialize session data to check if the user is logged in
      ...
      <Popover className={`AvatarDropdown relative flex ${className}`}>
        {({ open, close }) => (
          <>
            ...
            >
              <Popover.Panel className='absolute -right-10 top-full z-10 w-screen max-w-[260px] px-4 sm:right-0 sm:px-0'>
                      ...
                      <>
                        ...
                        <div className='flex items-center space-x-3'>
                          ...
                          <div className='flex-grow'>
                            ...
                            <p className='mt-0.5 text-xs'>{session.user.email}</p>
                          </div>
                        </div>
                        ...
                        {/* Log Out Button */}
                        <button
  className='-m-3 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 dark:hover:bg-neutral-700 w-full'
  onClick={() => signOut()}
>
                          <div className='flex flex-shrink-0 items-center justify-center text-neutral-500 dark:text-neutral-300'>
                            <svg
