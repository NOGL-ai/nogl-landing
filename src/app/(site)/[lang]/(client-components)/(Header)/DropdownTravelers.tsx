			...
			{({ open, close }) => (
                ...
                group h-10 self-center rounded-md py-2 text-sm font-medium hover:text-opacity-100 focus:outline-none sm:h-12 sm:text-base`}
                  ...
                  ml-2 h-5 w-5 text-neutral-700 transition duration-150 ease-in-out group-hover:text-opacity-80 `}
					...
					>
						<Popover.Panel className='absolute left-1/2 top-full z-40 w-screen max-w-xs -translate-x-1/2 transform px-4 sm:px-0'>
							<div className='overflow-hidden rounded-2xl shadow-lg ring-1 ring-black ring-opacity-5'>
								<div className='relative grid grid-cols-1 gap-7 bg-white p-7 dark:bg-neutral-800 '>
									{solutions.map((item, index) => (
										...
										>
											<div className='bg-primary-50 text-primary-500 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md sm:h-12 sm:w-12'>
