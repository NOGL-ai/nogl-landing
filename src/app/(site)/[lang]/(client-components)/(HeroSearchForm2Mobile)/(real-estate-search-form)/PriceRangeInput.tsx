					...
					<div>
						...
						<div className='relative mt-1 rounded-md'>
							...
							<input
								...
								name='minPrice'
								id='minPrice'
								className='focus:ring-primary-500 focus:border-primary-500 block w-full rounded-full border-neutral-200 pl-7 pr-3 text-neutral-900 sm:text-sm'
					...
					<div>
						...
						<div className='relative mt-1 rounded-md'>
							...
							<input
								...
								name='maxPrice'
								id='maxPrice'
								className='focus:ring-primary-500 focus:border-priring-primary-500 block w-full rounded-full border-neutral-200 pl-7 pr-3 text-neutral-900 sm:text-sm'
