...
export default async function MarketingAssetsOverviewPage({
  params,
}: {
  ...
  return (
    <div className="min-h-screen bg-bg-secondary p-6">
      <div className="mx-auto max-w-7xl space-y-8">
        {/* Header */}
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Marketing Asset Library</h1>
          <p className="mt-1 text-sm text-text-secondary">
            Competitor ads scraped from Meta Ads Library &amp; Instagram — live pipeline overview.
          </p>
        </div>
