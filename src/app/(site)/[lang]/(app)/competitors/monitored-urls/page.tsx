    ...
    <div className="w-full max-w-7xl mx-auto p-4 lg:p-6 space-y-6">
      <div className="flex flex-col gap-2">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
          <h1 className="text-2xl font-semibold tracking-tight text-gray-900">Monitored URLs</h1>
        </div>
        <p className="text-sm text-gray-600">Track competitor product URLs and compare prices against your catalog.</p>
      </div>
