...
const competitors = [
  {
    ...
    name: 'Pilgrim',
    domain: 'pilgrim.net',
    avatar: 'https://logo.clearbit.com/pilgrim.net?format=jpg',
    products: 85,
    position: 25,
    trend: 12,
    trendUp: true,
  ...
  },
  {
    ...
    name: 'Amoonic',
    domain: 'amoonic.de',
    avatar: 'https://logo.clearbit.com/amoonic.de?format=jpg',
    products: 42,
    position: 78,
    trend: 3,
    trendUp: false,
  ...
  },
  {
    ...
    name: 'Cluse',
    domain: 'cluse.com',
    avatar: 'https://logo.clearbit.com/cluse.com?format=jpg',
    products: 65,
    position: 35,
    trend: 15,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/eastsidewatches.com?format=jpg',
    products: 28,
    position: 88,
    trend: 2,
    trendUp: true,
  ...
  },
  {
    ...
    name: 'Engelssinn',
    domain: 'engelsinn.de',
    avatar: 'https://logo.clearbit.com/engelsinn.de?format=jpg',
    products: 38,
    position: 82,
    trend: 1,
    trendUp: false,
  ...
  },
  {
    ...
    name: 'fejn',
    domain: 'fejn.com',
    avatar: 'https://logo.clearbit.com/fejn.com?format=jpg',
    products: 52,
    position: 65,
    trend: 8,
    trendUp: true,
  ...
  },
  {
    ...
    name: 'float',
    domain: 'float.to',
    avatar: 'https://logo.clearbit.com/float.to?format=jpg',
    products: 15,
    position: 92,
    trend: 1,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/goldenstrawberry.de?format=jpg',
    products: 35,
    position: 85,
    trend: 4,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/heideman-store.de?format=jpg',
    products: 48,
    position: 75,
    trend: 2,
    trendUp: false,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/heyhappiness.com?format=jpg',
    products: 45,
    position: 80,
    trend: 6,
    trendUp: true,
  ...
  },
  {
    ...
    name: 'Jukserei',
    domain: 'jukserei.com',
    avatar: 'https://logo.clearbit.com/jukserei.com?format=jpg',
    products: 22,
    position: 90,
    trend: 3,
    trendUp: true,
  ...
  },
  {
    ...
    name: 'Luamaya',
    domain: 'luamaya.com',
    avatar: 'https://logo.clearbit.com/luamaya.com?format=jpg',
    products: 32,
    position: 88,
    trend: 4,
    trendUp: false,
  ...
  },
  {
    ...
    name: 'Nialaya',
    domain: 'nialaya.com',
    avatar: 'https://logo.clearbit.com/nialaya.com?format=jpg',
    products: 28,
    position: 90,
    trend: 5,
    trendUp: true,
  ...
  },
  {
    ...
    name: 'Nonu Berlin',
    domain: 'nonu.shop',
    avatar: 'https://logo.clearbit.com/nonu.shop?format=jpg',
    products: 42,
    position: 82,
    trend: 7,
    trendUp: true,
  ...
  },
  {
    ...
    name: 'Orelia',
    domain: 'orelia.co.uk',
    avatar: 'https://logo.clearbit.com/orelia.co.uk?format=jpg',
    products: 95,
    position: 40,
    trend: 18,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/picocopenhagen.com?format=jpg',
    products: 35,
    position: 85,
    trend: 2,
    trendUp: false,
  ...
  },
  {
    ...
    name: 'Purelei',
    domain: 'purelei.com',
    avatar: 'https://logo.clearbit.com/purelei.com?format=jpg',
    products: 58,
    position: 70,
    trend: 9,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/singularu.com?format=jpg',
    products: 18,
    position: 95,
    trend: 3,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/thesilvercollective.com?format=jpg',
    products: 72,
    position: 60,
    trend: 11,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/wunderklein.com?format=jpg',
    products: 38,
    position: 80,
    trend: 4,
    trendUp: false,
  ...
  },
  {
    ...
    name: 'Bynouk',
    domain: 'bynouck.com',
    avatar: 'https://logo.clearbit.com/bynouck.com?format=jpg',
    products: 25,
    position: 90,
    trend: 5,
    trendUp: true,
  ...
  },
  {
    ...
    name: 'Nana KAY',
    domain: 'nana-kay.com',
    avatar: 'https://logo.clearbit.com/nana-kay.com?format=jpg',
    products: 32,
    position: 88,
    trend: 6,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/rafaela-donata.com?format=jpg',
    products: 15,
    position: 95,
    trend: 2,
    trendUp: false,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/wanderlustandco.com?format=jpg',
    products: 88,
    position: 50,
    trend: 14,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/engelsrufer.de?format=jpg',
    products: 12,
    position: 98,
    trend: 1,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/makarojewelry.com?format=jpg',
    products: 45,
    position: 75,
    trend: 8,
    trendUp: true,
  ...
  },
  {
    ...
    avatar: 'https://logo.clearbit.com/brunathelabel.com?format=jpg',
    products: 28,
    position: 88,
    trend: 3,
    trendUp: false,
  ...
  },
  {
    ...
    name: 'PDPaola',
    domain: 'pdpaola.com',
    avatar: 'https://logo.clearbit.com/pdpaola.com?format=jpg',
    products: 125,
    position: 35,
    trend: 22,
    trendUp: true,
