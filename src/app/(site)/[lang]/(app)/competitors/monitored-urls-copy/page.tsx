...
import { CompetitorTable } from '@/components/organisms/tables-v2';
...
// Styling classes used throughout the page
  ...
  return (
    <>
      ...
      <section className="rounded-xl border border-border-secondary bg-card shadow-sm transition-colors">
        ...
        {/* CompetitorTable component with all built-in features */}
        <CompetitorTable
