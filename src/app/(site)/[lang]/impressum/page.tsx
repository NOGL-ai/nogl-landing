        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert">
            ...
            <div className="mb-8">
              ...
              <p>
                <strong>Telefon:</strong> +49 (0) 40 12345678<br />
                <strong>E-Mail:</strong> <a href="mailto:info@nogl.tech" className="text-primary hover:underline">info@nogl.tech</a><br />
                <strong>Website:</strong> <a href="https://nogl.tech" className="text-primary hover:underline">https://nogl.tech</a>
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p>
                <strong>Handelsregister:</strong> Amtsgericht Hamburg<br />
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">Kontakt für rechtliche Angelegenheiten</h2>
              <p>
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400 mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
              ...
              <p className="mt-2">
                Dieses Impressum wurde erstellt gemäß den Vorgaben des Telemediengesetzes (TMG) und 
