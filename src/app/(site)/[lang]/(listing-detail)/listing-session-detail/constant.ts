...
export const PHOTOS: string[] = [
  "https://i.ibb.co/BBxkzfY/Viola-Weller-KWERLE-final-1-jpg.webp",
  "https://images.pexels.com/photos/1591062/pexels-photo-1591062.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260",
  "https://images.pexels.com/photos/3182773/pexels-photo-3182773.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260",
  "https://images.pexels.com/photos/19387231/pexels-photo-19387231.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260",
...
export const Benefits_demos = [
  { name: "Transcript available", icon: "la-file-alt" },
  { name: "Interactive Q&A sessions", icon: "la-comments" },
  { name: "Dynamic content", icon: "la-play" },
  { name: "Access to recordings", icon: "la-video" },
  { name: "Practical examples", icon: "la-lightbulb" },
  { name: "Handouts and materials", icon: "la-book" },
  { name: "Discussion", icon: "la-users" },
  { name: "Introductory and advanced options", icon: "la-chart-line" },
  { name: "Community access", icon: "la-user-friends" },
];
