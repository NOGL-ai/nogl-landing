		...
		<div className={`nc-SectionHero relative ${className}`}>
			<div className='relative flex flex-col-reverse items-center gap-12 lg:flex-row lg:items-center lg:justify-between lg:gap-16'>
				...
				<div className='max-w-2xl flex-shrink-0 space-y-8 lg:w-1/2 lg:space-y-10'>
					<h1 className='text-3xl font-bold !leading-tight md:text-4xl xl:text-5xl'>
						...
						<span className='text-primary-600'>
							Forecast Trends & Predict Demand
						</span>
					</h1>

					<span className='block text-base font-medium text-neutral-600 sm:text-lg md:text-xl dark:text-neutral-400'>
						{subHeading}
					</span>

					<div className='flex flex-col space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0'>
						<ButtonPrimary href={btnLink as any}>{btnText}</ButtonPrimary>
						<ButtonPrimary
							href={"/" as any}
							className='text-primary-600 bg-white hover:bg-neutral-50 dark:bg-neutral-800 dark:text-neutral-100 dark:hover:bg-neutral-700'
						>
							How It Works
						</ButtonPrimary>
					</div>
				...
				<div className='relative flex-1 lg:w-1/2'>
					...
					{/* Floating Stats Card */}
					<div className='absolute -left-8 bottom-8 hidden rounded-2xl bg-white p-4 shadow-2xl lg:block dark:bg-neutral-800'>
