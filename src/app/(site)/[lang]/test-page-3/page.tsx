    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-[1280px] px-8 py-12">
        ...
        <div className="rounded-xl border border-[#E9EAEB] bg-white shadow-sm">
          <div className="p-6 border-b border-[#E9EAEB]">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <p className="mt-0.5 text-sm text-[#535862]">Keep track of competitor and their security ratings.</p>
              </div>
              <div className="flex items-center gap-3">
                <button className="flex items-center gap-1 rounded-lg border border-[#D5D7DA] bg-white px-3.5 py-2.5 text-sm font-semibold text-[#414651] shadow-sm transition-colors hover:bg-gray-50">
          ...
          <div className="border-b border-[#E9EAEB] px-6 py-3">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="relative max-w-[320px]">
                  <Search className="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-[#A4A7AE]" />
                  <input
                    type="text"
                    placeholder="Search"
