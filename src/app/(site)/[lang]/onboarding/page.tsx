...
export default function OnboardingPage() {
  ...
  const [formData, setFormData] = useState<OnboardingFormData>(DEFAULT_FORM_VALUES);
  ...
  const validateForm = () => {
    ...
    } else if (formData.referralSource === 'Other' && !formData.otherReferralSource?.trim()) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const requestBody = {
      ...
      image: uploadedImageKey ? `${uploadedImageKey}` : session?.user?.image || "",
      bio: formData.bio,
      ...
      socialLinks: formData.linkedin ? { professionalLink: formData.linkedin } : null,
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-6 sm:py-8 md:py-12 px-4 sm:px-6 lg:px-8">
      {/* Header */}
      ...
      {/* Form */}
      <div className="mt-6 sm:mt-8 w-full max-w-xs sm:max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 p-4 sm:p-6 md:p-8 lg:p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <div className="w-32 h-32 relative mb-4">
                    {profilePhoto ? (
                      <img
                        src={profilePhoto.startsWith("http") ? profilePhoto : URL.createObjectURL(file!)}
                        alt="Profile"
                  ...
                  <label
                    ...
                    className="cursor-pointer px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 text-sm font-medium"
                  >
                ...
                <div className="mt-4">
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full pl-3 pr-10 py-2 text-sm
                  ...
                  {!formData.displayName.trim() && (
                    <p className="mt-1 text-xs text-red-500">{VALIDATION_MESSAGES.displayName.required}</p>
                  )}
                </div>
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-1 flex justify-between text-xs">
                    <p className={`${!formData.bio?.trim() ? 'text-red-500' : 'text-gray-500'}`}>
                      {!formData.bio?.trim() ? VALIDATION_MESSAGES.bio.required : ''}
                    </p>
                    <p className={`${formData.bio && formData.bio.length > 500 ? 'text-red-500' : 'text-gray-500'}`}>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  {!formData.userType && (
                    <p className="mt-1 text-sm text-red-500">{VALIDATION_MESSAGES.userType.required}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {!formData.referralSource && (
                    <p className="mt-1 text-sm text-red-500">{VALIDATION_MESSAGES.referralSource.required}</p>
                  )}
                  {formData.referralSource === 'Other' && (
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, otherReferralSource: e.target.value })
                      }
                      className="mt-2 block w-full pl-3 pr-10 py-2 text-base border-gray-300
                                 focus:outline-none focus:ring-green-500 focus:border-green-500
                                 rounded-md dark:bg-gray-700 dark:border-gray-600"
                    />
                  )}
                ...
                <div className="p-4 sm:p-6 bg-green-50 dark:bg-green-900 rounded-xl">
                  ...
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-300 ml-8">
                    Join our exclusive community to access special features and connect with other members
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 sm:mt-8">
              <button
                ...
                className="w-full flex justify-center py-2 sm:py-3 px-4 border border-transparent 
                         rounded-md shadow-sm text-sm sm:text-base font-medium text-white 
