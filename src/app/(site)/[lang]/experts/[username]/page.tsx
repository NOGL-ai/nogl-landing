...
const AuthorPage: FC<AuthorPageProps> = ({}) => {
	const [categories] = useState(["All", "1:1 Call", "Group Calls", "Webinars"]);
		  ...
		  <div className="listingSection__wrap">
			<div>
			  ...
			  <span className="mt-2 block text-neutral-500 dark:text-neutral-400">
				Kevin Francis's listings are very rich, 5-star reviews help him to be more branded.
			  </span>
			</div>
			<div className="w-14 border-b border-neutral-200 dark:border-neutral-700"></div>
				...
				<Tab.Panels>
				  <Tab.Panel className="">
					<div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 md:gap-7">
					  {DEMO_STAY_LISTINGS.filter((_, i) => i < 4).map((stay: any) => (
				  ...
				  <Tab.Panel className="">
					<div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 md:gap-7">
					  {DEMO_EXPERTS_LISTINGS.filter((_, i) => i < 4).map((expert) => (
						<ExperiencesCard key={expert.id} data={expert} />
					  ))}
					</div>
					<div className="mt-11 flex items-center justify-center">
					  <ButtonSecondary>Show me more</ButtonSecondary>
