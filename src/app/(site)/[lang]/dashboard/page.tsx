...
export default function DashboardPage() {
  ...
  const priceChangesData = [
    { month: 'Jan', overpriced: 16, samePrice: 65, competitive: 80 },
    { month: 'Fab', overpriced: 29, samePrice: 34, competitive: 54 },
    { month: 'Mar', overpriced: 45, samePrice: 32, competitive: 82 },
    { month: 'Apr', overpriced: 16, samePrice: 22, competitive: 76 },
    { month: 'May', overpriced: 36, samePrice: 44, competitive: 80 },
    { month: 'Jun', overpriced: 28, samePrice: 21, competitive: 58 },
    { month: 'Jul', overpriced: 16, samePrice: 48, competitive: 80 },
    { month: 'Aug', overpriced: 16, samePrice: 44, competitive: 45 },
    { month: 'Sep', overpriced: 16, samePrice: 32, competitive: 17 },
    { month: 'Oct', overpriced: 30, samePrice: 54, competitive: 80 },
    { month: 'Nov', overpriced: 16, samePrice: 18, competitive: 80 },
    { month: 'Dec', overpriced: 16, samePrice: 65, competitive: 80 },
  ];

  const pieChartData = [
    { label: 'Overpriced', value: 1105, percentage: 87.50, color: '#FB3748' },
    { label: 'Same Price', value: 158, percentage: 12.50, color: '#CACFD8' },
    { label: 'Competitive', value: 95, percentage: 7.50, color: '#1FC16B' },
  ];

  const competitorColumns = [
    { id: 'product', label: 'Product', sortable: true, width: '300px' },
    { id: 'competitor', label: 'Competitor', sortable: true, width: '180px' },
    { id: 'change', label: 'Change', sortable: true, width: '180px' },
    { id: 'time', label: 'Time', sortable: true, width: '100px' },
  ];
  ...
  const stockColumns = [
    { id: 'product', label: 'Product', sortable: true, width: '300px' },
    { id: 'competitor', label: 'Competitor', sortable: true, width: '200px' },
    { id: 'stockChange', label: 'Change', sortable: true, width: '400px' },
    { id: 'time', label: 'Time', sortable: true, width: '120px' },
  ];
  ...
  const stockData = [
    {
      ...
      stockChange: { from: 'In stock', to: 'Out of stock' },
      time: '3 days ago'
    },
    {
      product: {
      ...
      stockChange: { from: 'Out of stock', to: 'In stock' },
      time: '3 days ago'
    },
    {
      product: {
    ...
    <SidebarLayout user={user} onLogout={handleLogout}>
      <div className="min-h-screen bg-[#F6F8FA] dark:bg-gray-900 p-5">
        ...
        <div className="flex justify-between gap-5 mb-5">
          ...
          <LoadingChart
            title="Key vendor insights"
            height="788px"
            className="w-[760px]"
          />

          <div className="flex flex-col justify-center gap-5 w-[316px]">
            {/* Profit Status with Missing Data */}
            <LoadingChart
              title="Profit status"
              height="354px"
        ...
        <div className="flex gap-5 mb-5">
          <div className="flex flex-col gap-5 flex-1">
            <LoadingChart
              title="Historical price leaders"
              height="200px"
              className="flex-1"
            />
            <LoadingChart
