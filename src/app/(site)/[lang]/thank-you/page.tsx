...
export const metadata: Metadata = {
	...
	description: `Thank you for booking your session with ${process.env.SITE_NAME}`,
};

const ThankYouPage = () => {
	return (
		<div className='min-h-screen bg-gradient-to-r from-blue-50 to-blue-100 dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900'>
			<div className='container mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8'>
				<div className='mx-auto max-w-3xl'>
					{/* Success Card */}
					<div className='rounded-2xl bg-white p-8 shadow-lg md:p-12 dark:bg-neutral-800'>
								...
								{[
									{
										...
										description:
											"We've sent a confirmation email with session details and instructions.",
									},
									{
										icon: (
											<svg
										...
										description:
											"Add the session to your calendar using the link in the email.",
									},
									{
										icon: (
											<svg
										...
										title: "Session Link",
										description:
											"The session link will be sent 24 hours before the scheduled time.",
									},
								].map((step, index) => (
									<div key={index} className='flex items-start space-x-4'>
										<div className='flex-shrink-0'>
											<div className='bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 flex h-10 w-10 items-center justify-center rounded-full'>
												{step.icon}
											</div>
										</div>
										<div>
						...
						<div className='space-y-4'>
							<Link
								...
								className='bg-primary-600 hover:bg-primary-700 block w-full rounded-lg px-4 py-3 text-center text-white transition duration-150 ease-in-out'
							>
								View My Bookings
							</Link>
							<Link
								href='/'
								className='block w-full rounded-lg bg-gray-100 px-4 py-3 text-center text-gray-700 transition duration-150 ease-in-out hover:bg-gray-200 dark:bg-neutral-700 dark:text-gray-200 dark:hover:bg-neutral-600'
							>
								Return to Home
							</Link>
						</div>
