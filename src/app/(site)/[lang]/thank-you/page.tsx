					...
					>
								...
								{[
									{
										...
										description: "We've sent a confirmation email with session details and instructions.",
									},
									{
										icon: (
											<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										...
										description: "Add the session to your calendar using the link in the email.",
									},
									{
										icon: (
											<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
										...
										title: "Session Link",
										description: "The session link will be sent 24 hours before the scheduled time.",
									},
								].map((step, index) => (
						...
						<div className="space-y-4">
							<Link
								...
								className="block w-full text-center bg-primary-600 hover:bg-primary-700 text-white py-3 px-4 rounded-lg transition duration-150 ease-in-out"
							>
								View My Bookings
							</Link>
							<Link
								href="/"
								className="block w-full text-center bg-gray-100 dark:bg-neutral-700 hover:bg-gray-200 dark:hover:bg-neutral-600 text-gray-700 dark:text-gray-200 py-3 px-4 rounded-lg transition duration-150 ease-in-out"
							>
								Return to Home
							</Link>
						</div>
