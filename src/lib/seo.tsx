...
export const getSEOTags = ({
	...
	const defaultImageBaseUrl =
		process.env.NEXT_PUBLIC_IMAGE_URL || defaultSiteUrl;
	...
	return {
		...
		openGraph: {
			...
			description:
				description ||
				"AI-Powered Fashion Trend Forecasting & Demand Prediction",
			...
			images: [
				{
					url: getImageUrl(image || defaultImageUrl, defaultImageBaseUrl),
					width: 1200,
					height: 630,
...
export const renderSchemaTags = (customSchema?: Record<string, any>) => {
	...
	const defaultSchema = {
		...
		description:
			"Nogl- AI-Powered Fashion Trend Forecasting & Demand Prediction",
