...
const testimonials = [
  {
    ...
    description: (
      <p>
        The Content Creation Strategy session gave me a clear direction for social media. 
        <Highlight>Communicating authentically and getting better responses.</Highlight>
      </p>
    ),
  },
  {
