	...
	return (
		...
		>
			<div className='absolute inset-0 overflow-visible [container-type:size]'>
				<div className='animate-shimmer-slide absolute inset-0 h-[100cqh]'>
					<div
						className='absolute -inset-full w-auto rotate-0 [background:conic-gradient(from_calc(270deg-(var(--spread)*0.5)),transparent_0,rgba(255,255,255,0.05)_var(--spread),transparent_var(--spread))]'
						style={{ "--spread": "90deg" } as React.CSSProperties}
					/>
				</div>
			</div>

			<Icon className='absolute relative right-2 top-2 z-10 text-7xl opacity-10' />
		...
		<section className='overflow-hidden px-4 py-12 pt-48'>
			<div className='mx-auto max-w-6xl'>
				<div className='mb-8 flex justify-between gap-4'>
					<h2 className='text-2xl font-bold leading-[1.2] sm:text-3xl md:text-4xl lg:text-5xl'>
						{dictionary.problem.title}{" "}
						<span className='text-neutral-400'>
							{dictionary.problem.subtitle}
						</span>
					</h2>
