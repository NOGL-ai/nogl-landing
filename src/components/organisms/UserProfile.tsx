	...
	return (
		<div className='border-t border-[#E2E4E9]/20'>
			<div className={`p-3 ${isCollapsed ? "flex justify-center" : ""}`}>
				...
				<Popover
					key={`profile-${isCollapsed ? "collapsed" : "expanded"}-${pathname}`}
					className='relative w-full'
				>
					{({ close }) => (
						<>
							<Popover.Button
								className={`flex w-full items-center gap-3 rounded-[10px] p-3 transition-colors hover:bg-white/5 ${isCollapsed ? "justify-center" : ""}`}
							>
							...
							>
								<Popover.Panel
									className={
										isCollapsed
											? "absolute bottom-full left-1/2 z-50 mb-2 w-56 -translate-x-1/2 transform overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-black/5 dark:bg-neutral-800"
											: "absolute bottom-full left-3 right-3 z-50 mb-2 overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-black/5 dark:bg-neutral-800"
									}
								>
