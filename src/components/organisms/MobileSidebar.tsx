...
interface MobileSidebarProps
	extends Omit<SidebarProps, "isCollapsed" | "onToggleCollapse"> {
	isOpen: boolean;
	onClose: () => void;
}
						...
						<Dialog.Panel className='relative mr-16 flex w-full max-w-xs flex-1'>
							...
							<div className={`flex h-full w-full bg-[#111729] ${className}`}>
								<div className='flex w-full flex-col'>
									{/* Header */}
									<div className='flex h-[84px] items-center justify-between border-b border-[#E2E4E9]/20 px-3'>
									...
									>
										...
										<div className='flex items-center gap-2 px-3 py-2'>
											<div className='h-5 w-5 text-[#9293A9]'>
												{versionInfo.icon}
											</div>
