...
const getTabStyles = ({ isFocusVisible, isSelected, isHovered }: AriaTabRenderProps) => ({
    ...
    "button-minimal": cx(
        ...
        isFocusVisible && "outline-2 -outline-offset-2",
        isSelected && "bg-primary_alt text-secondary shadow-xs ring-1 ring-border ring-inset",
    ),
    underline: cx(
...
export const Tab = (props: TabComponentProps) => {
    ...
    return (
        <AriaTab
            ...
            className={(prop) =>
                cx(
                    "z-10 flex h-max cursor-pointer items-center justify-center gap-2 rounded-md whitespace-nowrap text-tertiary transition duration-100 ease-linear",
