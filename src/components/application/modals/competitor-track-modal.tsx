		...
		<div className={cx("fixed inset-0 z-[9999] flex items-center justify-center px-4 py-7.5", isDark && "dark")}>
			...
			>
				...
				<div className="relative flex w-full flex-col items-center self-stretch">
					...
					<button
						onClick={onClose}
						className="absolute flex items-center justify-center rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 w-11 h-11 right-3 top-3"
					>
						<svg
				...
				<div className="flex w-full max-h-[calc(100vh-220px)] flex-col items-start gap-5 self-stretch overflow-y-auto px-6">
					...
					<div className="flex w-full flex-col items-start gap-4 self-stretch">
						...
						<div className="flex w-full flex-col items-start gap-1.5 self-stretch">
							<label
								className="text-gray-700 dark:text-gray-300 text-sm font-medium leading-5"
								style={{
									fontFamily: "Inter, -apple-system, Roboto, Helvetica, sans-serif",
								}}
							>
							...
							<input
								...
								className="flex w-full items-center gap-2 self-stretch outline-hidden px-3.5 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 text-base leading-6"
								style={{
									fontFamily: "Inter, -apple-system, Roboto, Helvetica, sans-serif",
								}}
							/>
						...
						<div className="flex w-full flex-col items-start gap-4 self-stretch sm:flex-row">
							...
							<div className="flex flex-1 flex-col items-start gap-1.5 self-stretch sm:max-w-[280px]">
								...
								<div
									className="flex w-full items-center gap-2 self-stretch px-3.5 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm"
								>
									<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-400 dark:text-gray-500">
										<path
									...
									<input
										...
										className="flex-1 bg-transparent outline-hidden text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 text-base leading-6"
										style={{
											fontFamily: "Inter, -apple-system, Roboto, Helvetica, sans-serif",
										}}
									/>
							...
							<div className="flex flex-1 flex-col items-start gap-1.5 self-stretch">
								...
								<div
									className="flex w-full items-start self-stretch overflow-hidden rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm"
								>
									<div
									...
									<input
										...
										className="flex-1 self-stretch border-l border-gray-300 dark:border-gray-600 bg-transparent outline-hidden px-3.5 py-2.5 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 text-base leading-6"
										style={{
											fontFamily: "Inter, -apple-system, Roboto, Helvetica, sans-serif",
										}}
									/>
							...
							<div className="flex w-full flex-col items-start gap-1.5 self-stretch sm:w-32">
								...
								<div className="relative w-full">
									<select
										...
										className="flex w-full cursor-pointer appearance-none items-center gap-2 self-stretch outline-hidden px-3.5 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm text-gray-900 dark:text-gray-100 text-base font-medium leading-6"
										style={{
											fontFamily: "Inter, -apple-system, Roboto, Helvetica, sans-serif",
										}}
									>
									...
									<svg
										className="pointer-events-none absolute w-5 h-5 right-3.5 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500"
										width="20"
										height="20"
										viewBox="0 0 20 20"
										fill="none"
						...
						<div className="flex w-full flex-col items-start gap-1.5 self-stretch">
							<div className="flex items-center gap-0.5">
								...
								<div className="flex items-center justify-center w-4 h-4">
									<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-400 dark:text-gray-500">
							...
							<div className="relative w-full self-stretch h-36">
								<textarea
									...
									className="h-full w-full resize-none self-stretch outline-hidden px-3.5 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 text-base leading-6"
									style={{
										fontFamily: "Inter, -apple-system, Roboto, Helvetica, sans-serif",
									}}
								/>
								<svg
									className="pointer-events-none absolute w-3 h-3 right-5 bottom-[18px] text-gray-300 dark:text-gray-600"
									width="12"
									height="12"
									viewBox="0 0 12 12"
									fill="none"
				...
				<div className="flex w-full flex-col items-start self-stretch pt-8">
					<div className="flex w-full items-start gap-3 self-stretch px-6 pb-6">
						...
						<button
							...
							className="flex flex-1 items-center justify-center gap-1.5 px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-[0_0_0_1px_rgba(10,13,18,0.18)_inset,0_-2px_0_0_rgba(10,13,18,0.05)_inset,0_1px_2px_0_rgba(10,13,18,0.05)] dark:shadow-[0_0_0_1px_rgba(255,255,255,0.1)_inset,0_-2px_0_0_rgba(255,255,255,0.05)_inset,0_1px_2px_0_rgba(0,0,0,0.2)] disabled:cursor-not-allowed disabled:opacity-50"
						>
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-400 dark:text-gray-500">
								<path
							...
							<span
								className="text-gray-700 dark:text-gray-300 text-base font-semibold leading-6"
								style={{
									fontFamily: "Inter, -apple-system, Roboto, Helvetica, sans-serif",
								}}
							>
