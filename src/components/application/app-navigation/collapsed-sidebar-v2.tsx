                                ...
                                <div className="overflow-clip relative rounded-[inherit] size-[32px]">
                                    <div className="absolute inset-0">
                                        <svg
                                            ...
                                            className="block max-w-none size-full [&>path:first-child]:fill-[#375DFB] [&>path:first-child]:dark:fill-[#5b7dff] [&>path:last-child]:fill-[#00C8F4] [&>path:last-child]:dark:fill-[#33d8ff]"
                                        >
                                            <path
