        ...
        <div className="border-b px-4 sm:px-6 py-3 space-y-1">
          ...
          <div className="flex items-center flex-wrap gap-x-2.5 gap-y-1">
            ...
            {product.discount_pct != null && product.discount_pct > 0 && (
              <>
                <span className="text-text-tertiary/40">·</span>
                <span className="inline-flex items-center rounded-full bg-brand-50 text-text-brand px-2.5 py-0.5 text-xs font-medium">
          ...
          {product.source_url && (
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-xs text-text-brand hover:underline break-all line-clamp-2"
              >
                {product.source_url
                  .replace(/^https?:\/\//, "")
                  .split("/")[0]}
        ...
        <div className="px-4 sm:px-6 py-4">
          ...
          <div className="relative rounded-lg border overflow-hidden h-52">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-border-brand/30 bg-brand-50 px-3 py-1 text-xs font-semibold text-text-brand tracking-wide uppercase">
                <span className="h-1.5 w-1.5 rounded-full bg-bg-brand-solid animate-pulse" />
                Coming Soon
              </span>
