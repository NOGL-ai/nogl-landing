              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
                    {/* Amazon Logo */}
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-md group-hover:bg-white transition-colors dark:bg-gray-700 dark:hover:bg-gray-600">
                  ...
                  <div className="underline text-sm text-blue-600 font-medium hover:no-underline dark:text-blue-400">
                ...
                >
                  ...
                  <div className="flex items-center justify-center w-16 h-16 bg-gray-100 rounded-md mb-6 group-hover:bg-white transition-colors dark:bg-gray-700 dark:hover:bg-gray-600">
                    {/* Storefront Icon */}
