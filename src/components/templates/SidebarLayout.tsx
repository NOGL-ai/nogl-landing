	...
	return (
		<div className={`flex h-screen ${className}`} onKeyDown={handleKeyDown}>
			...
			<div className="lg:hidden fixed left-0 top-0 z-50">
				<div className={`bg-white border-r border-[#e9eaeb] dark:bg-[#0a0d12] dark:border-[#252b37] flex flex-col items-center h-full w-16`}>
					<div className="flex flex-1 items-center justify-between px-4 py-3 w-full">
						...
						<button
							ref={mobileToggleRef}
							type='button'
							className={`bg-gray-50 dark:bg-[#0a0d12] cursor-pointer flex gap-2 items-center justify-center overflow-clip p-2 rounded-[8px]`}
							onClick={openMobile}
			...
			<main
				id="main-content"
				className="flex flex-1 flex-col overflow-hidden transition-all duration-300 ease-in-out lg:ml-16 ml-16 bg-white dark:bg-[#0a0d12]"
				role="main"
				aria-label="Main content"
			>

				{/* Page content */}
				<div className={`sidebar-scroll flex-1 overflow-y-auto bg-white dark:bg-[#0a0d12]`}>
					{children}
				</div>
			</main>
		</div>
