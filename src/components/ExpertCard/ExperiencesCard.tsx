			...
			<div className='flex h-full flex-col'>
				...
				<div className='flex flex-grow flex-col p-5'>
					...
					<div className='space-y-3'>
						...
						{/* Expertise Tags - Modified for 2 per row */}
						<div className='grid grid-cols-2 gap-2'>
							{expertise.slice(0, 4).map((skill: string, idx: number) => (
								<span
									key={idx}
									className='truncate rounded-full bg-teal-50 px-3 
										py-1 text-center 
										text-xs font-medium 
										text-teal-600 dark:bg-teal-900/30 dark:text-teal-400'
								>
									{skill}
								</span>
							))}
					...
					<div className='mt-5 border-t border-neutral-200 pt-4 dark:border-neutral-800'>
						...
						{/* Commented out View Profile button
