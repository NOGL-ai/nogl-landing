...
const DatafeedSettings: React.FC<DatafeedSettingsProps> = ({ className = "" }) => {
  ...
  return (
    <div className={`w-full ${className}`}>
      {/* Page Header */}
      <div className="flex items-center gap-3 p-5 md:p-8 bg-white border-b border-stroke-soft-200">
        <div className="flex items-center justify-center w-12 h-12 bg-bg-weak-100 rounded-full">
          <DocumentTextIcon className="w-6 h-6 text-text-sub-500" />
        </div>
        <div className="flex-1">
          <h1 className="text-lg font-medium text-text-main-900 leading-6 tracking-tight">
            Datafeed Settings
          </h1>
          <p className="text-sm text-text-sub-500 leading-5 tracking-tight">
      ...
      <div className="p-5 md:p-8 bg-white">
        <div className="flex flex-col lg:flex-row gap-6 mb-8">
          ...
          <Card className="flex-1 border border-stroke-soft-200 shadow-sm">
            <CardContent className="p-4">
              <div className="flex items-center gap-4 mb-3">
                <div className="flex-1">
                  <h3 className="text-base font-medium text-text-main-900 leading-6 tracking-tight">
                    Bigcommerce
                  </h3>
          ...
          <Card className="flex-1 border border-stroke-soft-200 shadow-sm">
            <CardContent className="p-4">
              <div className="mb-9">
                <h3 className="text-base text-text-main-900">
                  Imported Products <span className="text-sm text-text-soft-400">(last 24)</span>
                </h3>
              </div>
              
              <div className="flex justify-between items-start">
                <div className="flex flex-col gap-3">
                  <div className="text-4xl font-medium text-text-main-900 leading-tight tracking-tight">
                    225302
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1 px-1 py-0.5 bg-Alerts-Success-0 border border-Alerts-Success-200/20 rounded">
                      <ArrowUpIcon className="w-4 h-4 text-Alerts-Success-200" />
                      <span className="text-xs font-semibold text-Alerts-Success-200">+0%</span>
                    </div>
                    <span className="text-xs text-Greyscale-400">vs 2 Years ago</span>
                  </div>
                </div>
      ...
      <div className="p-5 md:p-8 bg-white border-t border-stroke-soft-200">
        <div className="mb-6">
          <h2 className="text-lg font-medium text-text-main-900 leading-6 tracking-tight">
            Feed Settings
          </h2>
          <p className="text-sm text-text-sub-500 leading-5 tracking-tight">
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex-1 pr-8">
              <h3 className="text-sm font-medium text-text-main-900 leading-5 mb-1">
                Import price Adjustment
              </h3>
              <p className="text-xs text-text-sub-500 leading-4">
            ...
            <div className="flex items-center gap-3 w-80">
              <div className="flex-1">
                <div className="relative">
                  <Select
                    ...
                    className="h-10 text-sm border-stroke-soft-200 bg-white rounded-lg pr-8 appearance-none"
                    sizeClass="h-10 px-3"
                  >
                  ...
                  <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                    <svg className="w-5 h-5 text-text-sub-500" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="w-28">
                <div className="flex border border-stroke-soft-200 rounded-lg bg-white overflow-hidden">
                  <Input
                    value={settings.priceAdjustmentValue}
                    onChange={(e) => handleSettingChange("priceAdjustmentValue", e.target.value)}
                    className="border-0 rounded-none h-10 text-sm flex-1"
                    sizeClass="h-10 px-3"
                    rounded="rounded-none"
                  />
                  <div className="flex items-center justify-center min-w-[40px] bg-bg-weak-100 border-l border-stroke-soft-200">
                    <span className="text-sm text-colorblack-70 font-medium">%</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="w-80">
              <Input
                ...
                className="h-10 text-sm border-stroke-soft-200 bg-white rounded-lg"
                sizeClass="h-10 px-3"
                rounded="rounded-lg"
              />
            </div>
