...
const withPillTypes = {
    ...
    [badgeTypes.badgeModern]: {
        ...
        styles: {
            gray: {
                root: "bg-background text-secondary ring-border",
                addon: "text-tertiary",
                addonButton: "hover:bg-utility-gray-100 text-utility-gray-400 hover:text-utility-gray-500",
            },
        },
...
const withBadgeTypes = {
    ...
    [badgeTypes.badgeModern]: {
        common: "size-max flex items-center whitespace-nowrap rounded-md ring-1 ring-inset bg-background text-secondary ring-border shadow-xs",
