...
export const styles = {
    secondary:
        "bg-background text-fg-quaternary shadow-xs-skeumorphic ring-1 ring-border ring-inset hover:bg-primary_hover hover:text-fg-quaternary_hover disabled:shadow-xs disabled:ring-disabled_subtle",
