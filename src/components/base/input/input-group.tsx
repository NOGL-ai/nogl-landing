...
export const InputPrefix = ({ isDisabled, children, ...props }: InputPrefixProps) => (
    <span
        {...props}
        className={cx(
            "flex text-md text-tertiary shadow-xs ring-1 ring-border ring-inset",
                ...
                <>
                    ...
                    <div
                        ...
                        className={cx(
                            ...
                            "has-[&>select]:shadow-xs has-[&>select]:ring-1 has-[&>select]:ring-border has-[&>select]:ring-inset has-[&>select]:has-[input:focus]:ring-2 has-[&>select]:has-[input:focus]:ring-border-brand",
