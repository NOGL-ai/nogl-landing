...
const styles = sortCx({
    ...
    "top-floating":
        "absolute -top-2 left-1/2 -translate-x-1/2 -translate-y-full rounded-lg bg-background px-3 py-2 text-xs font-semibold text-secondary shadow-lg ring-1 ring-border",
});
