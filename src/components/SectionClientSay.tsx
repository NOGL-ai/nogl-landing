...
const SectionClientSay: FC<SectionClientSayProps> = ({
	...
	return (
		<div className={`nc-SectionClientSay relative ${className} `}>
			{/* Heading updated to reflect the context of the platform */}
			<Heading desc="Here's what our users say about their experience" isCenter>
				Testimonials from Our Clients
			</Heading>
			<div className='relative mx-auto max-w-2xl md:mb-16'>
				{renderBg()}
				<Image className='mx-auto' src={clientSayMain} alt='Client feedback' />
