	...
	return (
		<div className='relative flex items-center justify-center py-2'>
			<button
				...
				className={
					"absolute left-0 flex items-center justify-center rounded-full p-2 hover:bg-secondary_bg"
				}
			...
			<button
				...
				className='absolute right-0 flex items-center justify-center rounded-full p-2 hover:bg-secondary_bg'
