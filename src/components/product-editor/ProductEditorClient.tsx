	...
	return (
		<div className="mx-auto max-w-6xl px-4 py-6 lg:px-8 lg:py-8">
			<div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
				<div>
					<h1 className="text-2xl font-semibold tracking-tight text-foreground">Product Editor</h1>
			...
			<div className="mb-4 rounded-xl border border-border bg-card p-4">
				<div className="mb-3 flex flex-wrap items-end gap-3 text-xs font-medium uppercase tracking-wide text-muted-foreground">
					<div className="flex min-w-[140px] flex-col gap-1 normal-case">
						<span className="text-[10px] uppercase tracking-wide">Companies</span>
						<select
							value={company}
					...
					<div className="flex min-w-[140px] flex-col gap-1 normal-case">
						<span className="text-[10px] uppercase tracking-wide">Product Type</span>
						<select
							value={productType}
					...
					<div className="flex min-w-[240px] flex-1 flex-col gap-1 normal-case">
				...
				<p className="text-sm text-muted-foreground">
					<span className="font-medium text-foreground">{total.toLocaleString()}</span> products match filters.
				</p>
			</div>

			<div className="mb-4 rounded-xl border border-border bg-card p-4">
				<h2 className="mb-2 text-sm font-semibold text-foreground">Bulk Edit Products</h2>
				...
				<button
					...
					className="mt-3 inline-flex h-9 items-center rounded-lg bg-primary px-4 text-sm font-medium text-primary-foreground disabled:opacity-60"
				>
					...
					<table className="w-full min-w-[860px] text-sm">
						...
						<tbody>
							{loading && items.length === 0 ? (
								...
								items.map((it) => (
									<tr key={it.productId} className="border-t border-border align-top">
										...
										<td className="px-3 py-3 text-foreground">{it.company}</td>
										<td className="px-3 py-3 text-muted-foreground">{it.productType}</td>
										<td className="px-3 py-3 text-foreground">{it.title}</td>
										<td className="px-3 py-3">
			...
			<p className="mt-4 text-xs text-muted-foreground">Locale: {lang}</p>
		</div>
	);
}
