...
import Features from "@/components/ui/features-horizontal";
...
const FEATURES_DATA = [
  ...
  },
  {
    ...
    content: "Benefit from recordings, transcripts, summaries, and AI chatbots.",
  ...
  },
  {
    ...
    content: "Engage with experts and peers through live chats and Q&A sessions.",
...
export default function Component() {
  return (
    ...
    >
      <Features collapseDelay={5000} linePosition="bottom" data={FEATURES_DATA} />
    </Section>
  );
}
