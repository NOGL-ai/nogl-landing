          ...
          <div className="flex items-center gap-2">
            ...
            {shouldShowExpandedContent && (
              <div className="flex flex-col">
                ...
                <span className="text-[#D7E0F4] font-inter text-[12px] font-normal leading-[12px]">
                  Company Ltd
                </span>
              </div>
            )}
            ...
            <div className="flex items-center gap-2">
              <button className="p-1">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 11.25L9.0004 14.25L6 11.25" stroke="#D7E0F4" strokeWidth="1.44" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
              <button onClick={onToggleCollapse} className="p-1">
                <svg width="20" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="2.29199" y="2.29175" width="15.4167" height="15.4167" rx="2.70833" stroke="#5B6F85" strokeWidth="1.25"/>
                  <path d="M7.5 1.66675V18.3334" stroke="#5B6F85" strokeWidth="1.25"/>
                  <path d="M13.4608 7.50006L10.937 10.0001L13.4608 12.5001" stroke="#5B6F85" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
            </div>
          )}
          ...
          <div className={clsx(
            ...
            {shouldShowExpandedContent && (
              <div className="flex items-center justify-between flex-1">
                ...
                <div className="px-2 py-0.5 bg-[#DF1C41] rounded-full">
                  <span className="text-white font-inter text-[12px] font-medium leading-3 uppercase tracking-[0.24px]">
