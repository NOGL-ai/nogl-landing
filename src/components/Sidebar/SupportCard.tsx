...
const SupportCard: React.FC<SupportCardProps> = ({ onDismiss }) => {
  return (
    <div className="relative p-4 bg-[#171D31] rounded-xl flex flex-col gap-3">
      {/* Header */}
      <div className="flex items-center gap-2.5">
        ...
        <h3 className="flex-1 text-white font-inter text-[16px] font-medium leading-6 tracking-[-0.176px]">
          Need support?
        </h3>
      </div>

      {/* Description */}
      <p className="text-[#9293A9] font-inter text-[14px] font-normal leading-5 tracking-[-0.084px]">
      ...
      <button
        onClick={onDismiss}
        className="absolute top-3 right-3 p-0.5 rounded-full hover:bg-white/10 transition-colors"
        aria-label="Dismiss support card"
      >
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M10 8.93949L13.7125 5.22699L14.773 6.28749L11.0605 9.99999L14.773 13.7125L13.7125 14.773L10 11.0605L6.28751 14.773L5.22701 13.7125L8.93951 9.99999L5.22701 6.28749L6.28751 5.22699L10 8.93949Z" fill="white"/>
        </svg>
      </button>
    </div>
  );
