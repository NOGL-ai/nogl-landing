...
export function VirtualDataTable<TData>({
			...
			>
				...
				<div className='max-h-96 overflow-auto'>
					{table.getRowModel().rows?.length ? (
						...
						<div className='flex h-24 items-center justify-center text-center text-gray-500 dark:text-gray-400'>
							No results found.
						</div>
					)}
				</div>
	...
	return (
		...
		>
			...
			<div className='flex items-center justify-between space-x-2 border-t border-gray-200 px-4 py-2 text-xs text-gray-600 dark:border-gray-700 dark:text-gray-400'>
				<div>
				...
				<div>Virtual scrolling enabled</div>
			</div>
		</div>
	);
}
