...
const Toggle: React.FC<ToggleProps> = ({
	...
	return (
		<button
			...
			disabled={disabled}
			className={cn(
				"relative h-5 w-8 rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2",
		...
		>
			...
			<div
				className={cn(
					"absolute left-0.5 top-0.5 h-4 w-7 rounded-full border-t transition-colors duration-200",
					checked
			...
			<div
				className={cn(
					"absolute top-1 h-3 w-3 rounded-full bg-white transition-transform duration-200 ease-in-out",
					"border-b border-l border-r border-white",
			...
			>
				...
				<div
					className={cn(
						"absolute left-1 top-1 h-1 w-1 rounded-full transition-colors duration-200",
