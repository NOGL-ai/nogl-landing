...
const TableRow = React.forwardRef<HTMLTableRowElement, TableRowProps>(
  ({ className, variant = 'default', ...props }, ref) => {
    const variants = {
      default: 'border-b transition-colors hover:bg-gray-50/50 data-[state=selected]:bg-gray-50',
      hover: 'border-b transition-colors hover:bg-gray-50 data-[state=selected]:bg-gray-50',
